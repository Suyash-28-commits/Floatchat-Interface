...
  const LINKS = {
    dashboard: "/landing", // Dashboard ab LandingPage.jsx par jayega
    reports: "/oceanReports", // Reports ab OceanReports.jsx par jayega
    docs: "/docs",
  };
...
        {/* Brand */}
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate(LINKS.dashboard)}>
