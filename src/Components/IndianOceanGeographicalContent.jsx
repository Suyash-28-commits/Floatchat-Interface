// src/components/IndianOceanGeographicalContent.jsx

import React, { useState } from 'react';

const IndianOceanGeographicalContent = () => {
    ...
    const renderContent = () => {
        if (activeSubTab === 'maps') {
            ...
            return (
                <iframe
                    className="w-full h-full border-0"
                    src="/Indian_Ocean_Graphical.html"
                    title="Indian Ocean Graphical Report"
                ></iframe>
            );
        }
        return null;
...
export default IndianOceanGeographicalContent;